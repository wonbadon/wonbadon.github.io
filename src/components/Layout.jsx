...
export default function Layout({ children }) {
  ...
  const shouldShowSupportCta = pathname === '/guide' || pathname === '/overtime-guide' || pathname === '/attendance-dispute-guide' || pathname === '/typhoon-workday-guide' || pathname === '/annual-leave-guide' || pathname === '/leave-guide' || pathname === '/part-time-rights-guide' || pathname === '/parental-leave-guide' || pathname === '/wage-rights' || pathname === '/salary-slip-guide' || pathname === '/insurance-benefits-guide' || pathname === '/leaving-job' || pathname === '/dismissal-guide' || pathname === '/probation-rights-guide' || pathname === '/complaint-guide' || pathname === '/severance-guide' || pathname === '/labor-pension-guide' || pathname === '/retirement-planning-guide' || pathname === '/faq' || pathname === '/about'
