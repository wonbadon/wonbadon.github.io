...
export const DEFAULT_DESCRIPTION = '2026 最新勞工權益計算工具，免費試算薪資、加班費、特休、資遣費、勞退與勞健保，並整理扣薪、離職、交接、年終、offer、請假、職災、排班、颱風假、兼職、試用期、育嬰與退休規劃重點。'
...
export const routeSeoEntries = [
  {
    ...
    keywords: ['勞工權益計算工具', '加班費計算機', '離職權益', '離職預告期', '特休天數計算', '資遣費計算機', '勞退試算', '勞健保保費計算', '扣薪怎麼辦', '請假權益', '被開除怎麼辦', '職災怎麼申請', '排班爭議', '勞工局申訴', '薪資單怎麼看', '颱風假有薪嗎', '打工兼職權益', '試用期可以開除嗎', '年終獎金', 'offer 比較', '離職交接清單', '育嬰留停', '勞保老年年金'],
  ...
  },
  {
    ...
    description: '整理加班費、請假、扣薪、職災、排班、颱風假、兼職、試用期、年終、offer 比較、離職交接、申訴、育嬰與退休規劃中最常見的法條口徑、輸入誤區與結果差異。',
    keywords: ['勞工權益 FAQ', '加班費常見問題', '請假常見問題', '扣薪常見問題', '職災常見問題', '排班常見問題', '颱風假常見問題', '兼職常見問題', '試用期常見問題', '年終常見問題', 'offer 比較常見問題', '離職交接常見問題', '申訴常見問題', '育嬰留停常見問題', '退休規劃常見問題'],
    schemaType: 'FAQPage',
  },
  {
    path: '/about',
