...
const mappingRows = [
  ...
  {
    situation: '公司說你是變形工時或責任制，想先知道加班費和輪班津貼該怎麼分',
    page: '變形工時、責任制與輪班津貼懶人包',
    check: '先把班表、打卡紀錄、工時總量與津貼項目拆開，制度名稱和實際出勤不要混在一起。',
  ...
  {
    situation: '發現投保薪資比實領低，或同時有正職兼職，想先知道勞健保該怎麼保',
    page: '勞健保高薪低報與兼職投保懶人包',
    check: '先把底薪、固定津貼、投保薪資、勞退級距與多份工作狀況放在一起看，不要只看單月保費差額。',
  ...
  {
    situation: '剛被資遣或非自願離職，想先整理失業給付文件、證明名稱與申請時程',
    page: '失業給付與非自願離職文件懶人包',
    check: '先分清楚資遣通知、離職證明、服務證明與非自願離職文件，並把最後工作日和申請節點排成時間線。',
